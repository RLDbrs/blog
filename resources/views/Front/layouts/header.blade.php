...
<head>
  ...
  <link rel="icon" type="image/png" href="front/img/RLD_sm-min.png" width="100%">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{route('hompage')}}">
        @if($config->logo!=null)
        <img src="{{asset($config->logo)}}" width="50" /> STUDİO
        @else
        {{$config->title}}
        @endif</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="{{route('hompage')}}">Anasyfa</a>
          </li>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('@yield('bg',asset('front/img/rld_heat_tarzı.gif'))')">
